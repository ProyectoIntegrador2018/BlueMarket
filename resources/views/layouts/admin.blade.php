			...
			<nav class="main-nav navbar navbar-light" style="background-color: #fff">
				...
				<div class="navbar-brand">
					<a href="#" class="user-avatar">
						{{ Auth::user()->name }}
						<img class="user-avatar-img" src="{{ isset(Auth::user()->picture_url) ? Auth::user()->picture_url : 'http://colegioclassea.com.br/wp-content/themes/PageLand/assets/img/avatar/avatar.jpg' }}" alt="{{ Auth::user()->name }}">
					</a>
				</div>
			</nav>
