    ...
    <div class="home view-projects">
        <div class="overlay">
            <div class="contents">
                ...
                <button class="ui primary button">View projects</button>
            </div>
        </div>
    </div>
            ...
            <div class="home info steps">
                ...
                <ul class="progress">
                    <li class="progress-item">
                        <p class="progress-title">Step 1</p>
                        <p class="progress-info">Register in the platform</p>
                    </li>
                    <li class="progress-item">
                        <p class="progress-title">Step 2</p>
                        <p class="progress-info">Find and submit projects</p>
                    </li>
                    <li class="progress-item">
                        <p class="progress-title">Step 3</p>
                        <p class="progress-info">Find and collaborate with people</p>
                    </li>
                </ul>
            </div>
        </div>
